        ...
        <div class="container-accueil"> 
            <div class="bloc-1-accueil">
                <section class="presentation-accueil">
                    <h2 class="titre-blue">A propos de Moi !</h2>
                    <div class="container-presentation-accueil">
                        ...
                        <div class="contenu-presentation-accueil">
                            <p>Bonjour, Moi c'est <span class="span-blue">David</span>, j'ai 32 ans et je suis passionné par <span class="span-blue">l'informatique et les jeux vidéo</span>  depuis l'enfance.</p>
                            ...
                            <p>Actuellement, je prépare le titre <span class="span-blue">"Développeur web/web mobile"</span> afin de devenir <span class="span-blue">Développeur Full Stack.</span></p>
                        </div>  
                    </div>
            ...
            <div class="bloc-3-accueil">
                <section class="formations-accueil">
                    <h2 class="titre-blue">Formations</h2>
                    <div class="container-formations-accueil">
                        <div class="formation-1-accueil">
                            <h3 class="titre-blue">Pré-qualification Développeur Web / Web Mobile à <span>l'Ecole Atypique</span></h3>
                        ...
                        <div class="formation-2-accueil">   
                                <h3 class="titre-blue">Formation Intégrateur Web avec <span>OpenClassrooms</span></h3>
                                <ul>
                                    <li>HTML5</li>
                                    <li>CSS3</li>
                                    <li>VS Code</li>
